...
test("test", async ({ page }) => {
  ...
  await page.locator(".person-custom-select-genre__value-container").click();
  await page.locator("#react-select-genre-option-2").click();
  ...
  await page.locator("#react-select-type-dhebergement-option-2").click();
  await page.locator(".person-custom-select-nationalite__value-container").click();
  await page.locator("#react-select-nationalite-option-0").click();
  await page.locator(".person-custom-select-emploi__value-container").click();
  await page.locator("#react-select-emploi-option-3").click();
  await page.locator(".person-custom-select-ressources__value-container").click();
  await page.locator("#react-select-ressources-option-1").click();
  await page.locator("div:nth-child(2) > .row > div:nth-child(10)").click();
  await page.locator("#react-select-motif-de-la-situation-en-rue-option-2").click();
  await page.getByRole("dialog").getByText("Informations médicales").click();
  await page.locator(".person-custom-select-couvertures-medicales__value-container").click();
  await page.locator("#react-select-couvertures-medicales-option-1").click();
  await page.locator(".person-custom-select-couvertures-medicales__value-container").click();
  await page.locator("#react-select-couvertures-medicales-option-3").click();
  ...
  await changeReactSelectValue(page, "person-custom-select-genre", "Homme");
  ...
  await page.locator("#react-select-outOfActiveListmotif-de-la-situation-en-rue-option-4").click();
  await page.getByRole("button", { name: "Sauvegarder" }).click();
