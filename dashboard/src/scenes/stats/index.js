...
const Stats = () => {
  ...
  const personsUpdated = useMemo(() => {
    console.log(JSON.stringify({ filterByTeam, period, teamsOffsetHours, filterPersons }));
