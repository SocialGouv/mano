  ...
  return (
    <>
      <section
        ...
        <p className="tw-m-0 tw-w-full tw-text-center tw-text-6xl tw-font-bold tw-text-main">{personsCreated.length}</p>
        <p className="tw-m-0 tw-w-full tw-text-center tw-text-xl tw-font-semibold tw-text-main">
