...
const Drawer = () => {
  ...
  return (
    <nav
      ...
      className={[
        'noprint tw-absolute tw-flex tw-h-screen tw-w-screen tw-overflow-hidden tw-bg-gray-900/80 tw-opacity-100 tw-transition-all sm:!tw-pointer-events-auto sm:!tw-visible sm:tw-relative sm:!tw-z-[2000] sm:tw-h-auto sm:tw-w-auto sm:tw-translate-x-0 sm:tw-bg-transparent',
        showDrawer
          ? 'tw-visible tw-z-[2000] tw-translate-x-0 tw-transition-all'
