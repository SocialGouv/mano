    ...
    <>
      ...
      <ModalContainer open={open} onAfterEnter={() => setModalIsOpened(true)} onBeforeLeave={() => setModalIsOpened(false)}>
        ...
        <ModalFooter>
          <button
            type="button"
            className="tw-mt-3 tw-inline-flex tw-w-full tw-justify-center tw-rounded-md tw-border tw-border-gray-300 tw-bg-white tw-px-4 tw-py-2 tw-text-base tw-font-medium tw-text-gray-700 tw-shadow-sm hover:tw-bg-gray-50 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-main focus:tw-ring-offset-2 sm:tw-ml-3 sm:tw-mt-0 sm:tw-w-auto sm:tw-text-sm"
            name="cancel"
