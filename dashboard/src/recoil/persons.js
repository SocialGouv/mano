...
export const personFields = [
  { name: 'user', label: '', encrypted: true, importable: false },
  { name: 'name', label: 'Nom prénom ou Pseudonyme', encrypted: true, importable: true },
  { name: 'otherNames', label: 'Autres pseudos', encrypted: true, importable: true },
  { name: 'gender', label: 'Genre', encrypted: true, importable: true, options: genderOptions },
  { name: 'birthdate', label: 'Date de naissance', encrypted: true, importable: true },
  { name: 'description', label: 'Description', encrypted: true, importable: true },
  { name: 'alertness', label: 'Personne très vulnérable', encrypted: true, importable: true },
  { name: 'wanderingAt', label: 'En rue depuis le', encrypted: true, importable: true },
  { name: 'personalSituation', label: 'Situation personnelle', encrypted: true, importable: true, options: personalSituationOptions },
  { name: 'nationalitySituation', label: 'Nationalité', encrypted: true, importable: true, options: nationalitySituationOptions },
  { name: 'hasAnimal', label: 'Avec animaux', encrypted: true, importable: true, options: yesNoOptions },
  { name: 'structureSocial', label: 'Structure de suivi social', encrypted: true, importable: true },
  { name: 'structureMedical', label: 'Structure de suivi médical', encrypted: true, importable: true },
  { name: 'employment', label: 'Emploi', encrypted: true, importable: true, options: employmentOptions },
  { name: 'address', label: 'Hébergement', encrypted: true, importable: true, options: yesNoOptions },
  { name: 'addressDetail', label: "Type d'hébergement", encrypted: true, importable: true },
  { name: 'resources', label: 'Ressources', encrypted: true, importable: true, options: ressourcesOptions },
  { name: 'reasons', label: 'Motif de la situation en rue', encrypted: true, importable: true, options: reasonsOptions },
  { name: 'healthInsurance', label: 'Couverture médicale', encrypted: true, importable: true, options: healthInsuranceOptions },
  { name: 'vulnerabilities', label: 'Vulnérabilités', encrypted: true, importable: true, options: vulnerabilitiesOptions },
  { name: 'consumptions', label: 'Consommations', encrypted: true, importable: true, options: consumptionsOptions },
  { name: 'phone', label: 'Téléphone', encrypted: true, importable: true },
  ...
  { name: 'createdAt', label: 'Suivi(e) depuis le / Créé le', encrypted: false, importable: true },
  { name: 'updatedAt', label: '', encrypted: false, importable: false },
  { name: 'outOfActiveList', label: 'Sortie de file active', encrypted: false, importable: false, options: yesNoOptions },
  {
