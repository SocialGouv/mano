...
COPY mano."Organisation" (_id, name, "createdAt", "updatedAt", categories, "actionsGroupedCategories", consultations, "encryptionEnabled", "encryptionLastUpdateAt", encrypting, "receptionEnabled", services, collaborations, "customFieldsObs", "customFieldsPersonsSocial", "customFieldsPersonsMedical", "encryptedVerificationKey", migrations, "migrationLastUpdateAt", migrating, "customFieldsMedicalFile") FROM stdin;
...
COPY mano."Structure" (_id, name, description, city, postcode, adresse, phone, organisation, categories, "actionsGroupedCategories", "createdAt", "updatedAt") FROM stdin;
